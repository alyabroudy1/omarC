...
import com.arabseed.utils.DomainConfigManager
import com.arabseed.utils.CloudflareChallengeDialog
import com.arabseed.service.cloudflare.CloudflareDetector
import com.arabseed.service.cookie.CookieLifecycleManager
import com.arabseed.service.strategy.*
...
class ProviderSessionManager(
        ...
        return cfMutex.withLock {
            ...
            if (!currentCookies.isNullOrEmpty()) {
                ...
                if (directHttpStrategy.canHandle(RequestContext(url, hasValidCookies = true))) {
                    ...
                    if (retryResponse.success || !retryResponse.isCloudflareChallenge) {
    ...
    fun hasValidSession(): Boolean {
        return cookieManager.isValid(currentDomain)
    }
