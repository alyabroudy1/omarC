package com.arabseed.service.strategy
...
import com.arabseed.service.ProviderLogger.TAG_VIDEO_SNIFFER
import com.arabseed.service.cloudflare.CloudflareDetector
import com.arabseed.service.cookie.CookieLifecycleManager
...
class VideoSniffingStrategy(
    ...
    private fun createWebView(url: String, userAgent: String, cookies: Map<String, String>): WebView {
        // Try to get PluginContext context if available, otherwise use provided context
        val ctx = try { PluginContext.context ?: context } catch(e: Exception) { context }
