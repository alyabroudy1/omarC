...
class YallaShootParser : NewBaseParser() {
    ...
    override fun parseLoadPage(doc: Document, url: String): ParserInterface.ParsedLoadData? {
        ...
        // In shoot-one.com, matches don't necessarily contain "/matches/". They can be like "/2026/03/sport1.html".
        val isLive = tableRows.isNotEmpty() || url.contains(".html")
