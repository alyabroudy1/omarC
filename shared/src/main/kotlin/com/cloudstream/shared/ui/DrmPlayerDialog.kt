...
/**
 * A self-contained, generic DRM/Web Video Player Dialog.
 * Uses programmatic UI generation to avoid XML resource dependencies.
 */
class DrmPlayerDialog(
    private val activity: Activity,
    private val url: String,
    private val referer: String? = null
) : Dialog(activity, android.R.style.Theme_Black_NoTitleBar_Fullscreen) {

    private val TAG = "DrmPlayerDialog"
    ...
    private fun getResId(name: String, type: String): Int {
        ...
        // Try host app
        var id = res.getIdentifier(name, type, "com.lagradost.cloudstream3")
        
        if (id == 0) {
            Log.e(TAG, "getResId FAILED for $name type $type. Tried: com.lagradost.cloudstream3")
        }
        return id
    }
